...
export function ChatSidebar({
  ...
  return (
    <aside className="hidden w-full shrink-0 flex-col border-b border-slate-200 bg-white md:flex md:w-[350px] md:border-b-0 md:border-r">
      <div className="flex items-center justify-between px-5 pb-3 pt-4">
        <h1 className="text-2xl font-bold tracking-tight text-slate-900">แชท</h1>
        <button
          onClick={onSignOut}
          className="rounded-full border border-slate-300 px-4 py-1.5 text-xs text-slate-700 transition hover:bg-slate-100"
        >
          Logout
        </button>
      </div>
